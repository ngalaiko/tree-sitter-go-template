...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    case 0:
      ...
      if (set_contains(sym_identifier_character_set_1, 678, lookahead)) ADVANCE(183);
      END_STATE();
    case 1:
      ADVANCE_MAP(
        ' ', 120,
    ...
    case 99:
      ...
      if (set_contains(aux_sym_variable_token1_character_set_1, 679, lookahead)) ADVANCE(183);
      END_STATE();
    case 100:
